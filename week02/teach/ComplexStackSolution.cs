public static class ComplexStackSolution {
    public static void Main() {
        // True (passes on line 33 ... stack was empty at the end)
        Console.WriteLine(CheckBraces("(a == 3 or (b == 5 and c == 6))"));
        //  False ..wrong opening square bracket (fails on line 25 ... stack had only '(' in it before it was popped and compared with ']')
        //                          here -------\/
        Console.WriteLine(CheckBraces("(students]i].Grade > 80 and students[i].Grade < 90"));
        // False .... missing closing ')' (fails on line 33 ... stack had an extra '(' in it at the end when it was supposed to be empty
        //                 here -------\/
